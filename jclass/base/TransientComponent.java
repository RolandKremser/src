...
public abstract class TransientComponent extends BaseComponent
{
    ...
    protected void drawBorder(Graphics g)
    {
        ...
        if(getBorder() != null)
            ...
            jclass.base.Border.draw(g, super.border_style, super.border, highlight, highlight, getSize().width - 2 * highlight, getSize().height - 2 * highlight, getBackground(), getForeground());
    }
    ...
    {
        int i = pref_width == -999 ? !isDisplayable() ? 0 : preferredWidth() : pref_width;
        i = i >= 0 ? i + 2 * super.border + 2 * highlight + super.insets.left + super.insets.right : 50;
        int j = pref_height == -999 ? !isDisplayable() ? 0 : preferredHeight() : pref_height;
